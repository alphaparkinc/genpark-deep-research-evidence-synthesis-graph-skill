# genpark-deep-research-evidence-synthesis-graph-skill
...
**genpark-deep-research-evidence-synthesis-graph-skill** is a deterministic, zero-dependency Python skill engineered for autonomous AI agents, multi-agent frameworks (Claude Desktop, Cursor, AutoGPT, CrewAI), and enterprise pipelines.

> **Executive Capability**: Deep research evidence synthesis graph & citation verification (MindSearch)
...
result = client.synthesize_research_graph()
print(result)
```
...
```json
{
  "mcpServers": {
    "genpark-deep-research-evidence-synthesis-graph-skill": {
      "command": "python",
      "args": ["/path/to/genpark-deep-research-evidence-synthesis-graph-skill/mcp_server.py"]
    }
  }
}
```
